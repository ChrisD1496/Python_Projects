...
class RegressionModels:
    ...
    def principal_component_regression(self, dependent_variable, independent_variables, n_components=None, test_size=0.2, random_state=42):
        ...
        mean_absolute_error_val = mean_absolute_error(test_y, y_hat)
        mean_squared_error_val = mean_squared_error(test_y, y_hat)

        return r2_score_val, mean_absolute_error_val, mean_squared_error_val
    ...
    def simple_linear_regression(self, dependent_variable, independent_variable, test_size=0.2, random_state=42):
        ...
        mean_absolute_error_val = mean_absolute_error(test_y, test_y_)
        mean_squared_error_val = mean_squared_error(test_y, test_y_)
    ...
    def multiple_regression(self, dependent_variables, independent_variable, test_size=0.2, random_state=42):
        ...
        residual_sum_of_squares = mean_squared_error(test_y, y_hat)
    ...
    def polynomial_regression(self, dependent_variables, independent_variable, test_size=0.2, random_state=42, degree=2):
        ...
        train_x = np.asanyarray(train[[independent_variable]])
        train_y = np.asanyarray(train[[dependent_variables]])

        test_x = np.asanyarray(test[[independent_variable]])
        test_y = np.asanyarray(test[[dependent_variables]])
    ...
    def ransac_regression(self, dependent_variables, independent_variable, test_size=0.2, random_state=42):
        """
        Perform Polynomial Regression with RANSAC.
        ...
        ransac = RANSACRegressor(base_estimator=LinearRegression(), random_state=random_state)
        ransac.fit(train_x, train_y)

        test_y_ = ransac.predict(test_x)
